...
import { RookieSlotsEditor } from './rookie-slots-editor';
import { Routes } from '@/routes';

export default async function AdminRookieSlotsPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      ...
      <h1 className="mb-6 font-[family-name:var(--font-display)] text-2xl font-bold uppercase tracking-tight">
        Rookie Slot Values Import
      </h1>
      <RookieSlotsEditor initialYear={statsYear} />
    </main>
  );
}
